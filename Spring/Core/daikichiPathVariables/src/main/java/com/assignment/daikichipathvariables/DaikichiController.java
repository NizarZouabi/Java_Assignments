package com.assignment.daikichipathvariables;
...
public class DaikichiController {
	...
	public String lotto(@PathVariable("lottoNum") int lottoNum) {
		if (lottoNum % 2 == 0) {
			...
			return "You have enjoyed the fruits of your labor but now is a geat time to spend time with family and friends.";
		}
	}
